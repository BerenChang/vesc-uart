...
class COMM_Types(Enum):
    ...
    COMM_SET_CURRENT_WITH_ERPM = 111
    COMM_SET_CURRENT_WITH_ERPM_SETUP = 112
    COMM_SET_CURRENT_SETUP = 113
    COMM_SET_PROFILE = 114
    COMM_GET_PROFILE = 115
    COM_SET_WARM_MOTOR_MODE = 116
    COMM_SET_WARM_MOTORS = 117
    COMM_SET_WARM_MOTORS_SETUP = 118
    COMM_SET_WARM_MOTORS_STOP = 119
    COMM_SET_RATIO_BRAKE = 120
    COMM_SET_CURRENT_SINGLE = 121

    COMM_GET_VALUES_PIDISPLAY = 122
    COMM_SET_ZERO_TURN = 123
    COMM_SET_REMOTE_CONTROL = 124
